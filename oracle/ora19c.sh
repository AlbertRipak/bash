...
mkdir -p /u01/app/grid/product/19/grid_home
...
ORACLE_HOME=$ORACLE_BASE/product/19/grid_home; export ORACLE_HOME
...
ORACLE_HOME=$ORACLE_BASE/product/19/dbhome_1; export ORACLE_HOME
